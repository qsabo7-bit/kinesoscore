...
export const FITNESS_ASSESSMENTS = {
  'max-pushups': {
    ...
    events: [
      {
        id: 'reps',
        label: 'Push-ups in 1 minute',
        kind: 'reps',
        placeholder: '45',
        hint: 'Total completed repetitions in 60 seconds',
      },
    ],
    ...
    events: [
      {
        ...
        placeholderMin: '3',
        placeholderSec: '30',
        hint: 'Total time to complete 21-15-9 thrusters and pull-ups',
      },
    ],
    ...
    events: [
      {
        ...
        placeholderMin: '45',
        placeholderSec: '00',
        hint: 'Total time including both miles and calisthenics',
      },
    ],
    higherIsBetter: false,
    resultUnit: 'sec',
    ...
    events: [
      {
        ...
        kind: 'reps',
        placeholder: '15',
        hint: 'Complete rounds of 5 pull-ups / 10 push-ups / 15 squats',
      },
      {
        id: 'extraReps',
        label: 'Extra reps',
        kind: 'reps',
        placeholder: '8',
        hint: 'Reps into the next round (0–29). Pull-ups count first, then push-ups, then squats.',
      },
    ],
    exerciseName: 'Cindy',
    trackId: 'cindy',
