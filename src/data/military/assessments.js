...
export const MILITARY_ASSESSMENTS = {
  'air-force-pfra': {
    ...
    lead: 'Score your Air Force Physical Fitness Readiness Assessment from published standards. Select age band and gender, then enter each component.',
  ...
  'army-aft': {
    ...
    shortName: 'Army AFT',
    eyebrow: 'Military assessment',
    lead: 'Score your Army Fitness Test from published AFT standards. Enter age, gender, and each event result.',
    infoStatus: 'Current',
    scoringReady: true,
    scoringStatusMessage: '',
    source: {
  ...
  'marine-pft': {
    ...
    eyebrow: 'Military assessment',
    lead: 'Score your Marine Corps Physical Fitness Test from published PFT standards.',
    infoStatus: 'Current',
    scoringReady: true,
    scoringStatusMessage: '',
    source: {
  ...
  'navy-prt': {
    ...
    shortName: 'Navy PRT',
    eyebrow: 'Military assessment',
    lead: 'Score your Navy Physical Readiness Test from published PRT standards.',
    infoStatus: 'Current',
    scoringReady: true,
    scoringStatusMessage: '',
    source: {
