...
--   * alter performance_records / profiles / user_defaults / leaderboard_profiles rules
--   * add public SELECT on shares
--   * expose public leaderboard RPCs (Stage 5+)
--   * auto-share on calculator save
-- Private by default: a Leaderboard Name alone never publishes results.
